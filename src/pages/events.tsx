...
const Events = () => {
    ...
    return (
        <div className='bg-[#151515] pb-10'>
            <div className="   md:px-12 xl:px-6">
                <div className="relative pt-36 ">
                    <div className="lg:w-2/3 md:text-center  mx-auto">
                        <h1 className="text-white font-bold text-4xl md:text-6xl xl:text-7xl">Events<span className="text-primary text-[#EACD69]">.</span></h1>
                        ...
                        {eventToShow.map((event) => (
                            <Link href={{ pathname: `/event/${event.alias}` }}>
                                ...
                                <div className='bg-slate-100 p-3 rounded-3xl m-4'>
                                    ...
                                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 pt-3 text-center  dark:text-white">{event.name}</h5>
                                </div>
                            </Link>
                        ))}
                    </div>
            ...
            {!showAllEvents && (
                <Link href={{ pathname: "/events", query: { allEvents: true } }} className="lg:w-2/3 md:text-center  mx-auto flex justify-center">
