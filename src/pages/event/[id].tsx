                    ...
                    <div className="space-y-4">
                        <div className="md:p-10 ">
                            <h4 className='text-3xl  font-bold font-headings md:text-5xl'>
                                About Event.
                            </h4>                        <p className='md:p-5 mt-4'>{event.aboutEvent}</p>
                        </div>
                        <div className="md:p-10">
                            <h4 className='text-3xl font-bold  font-headings md:text-5xl'>
                                Event Details.
                                ...
                                {event.eventDetail.map((item, index) => (
                                    <li className='lg:p-2 lg:ml-10 ' key={index}>{item}</li>
                                ))}
                            </ul>
                        </div>
                        <div className="md:p-10">
                        ...
                        <div className="md:p-10">
                            ...
                            <div className="space-y-2 mt-5">
                                {event.coordinators.students.map((item, index) => (
                                    <p className='lg:p-2 lg:ml-10 ' key={index}>
                        ...
                        <div className="md:p-10">
                            ...
                            <div className="space-y-2 mt-5 ">
                                {event.coordinators.faculty.map((item, index) => (
                                    <p className='lg:p-2 lg:ml-10 ' key={index}>Prof. {item}</p>
                                ))}
                            </div>
                        </div>
                    </div>
