                ...
                <div className="space-y-4">
                    <div className="p-10">
                        <h4 className='text-3xl  font-bold font-headings md:text-5xl'>
                            About Event.
                        </h4>                        <p className='p-5'>{event.aboutEvent}</p>
                    </div>
                    <div className="p-10 ">
                        <h4 className='text-3xl font-bold  font-headings md:text-5xl'>
                            Event Details.
                        </h4>                          <ul className="list-disc pl-4">
                            {event.eventDetail.map((item, index) => (
                                <li className='p-2 ml-10' key={index}>{item}</li>
                            ))}
                        </ul>
                    </div>
                    <div className="p-10">
                    ...
                    <div className="p-10">
                        ...
                        <div className="space-y-2 mt-5">
                            {event.coordinators.students.map((item, index) => (
                                <p className='p-2 ml-10 ' key={index}>
                    ...
                    <div className="p-10">
                        ...
                        <div className="space-y-2 mt-5 ">
                            {event.coordinators.faculty.map((item, index) => (
                                <p className='p-2 ml-10 ' key={index}>Prof. {item}</p>
                            ))}
                        </div>
                    </div>
                </div>
